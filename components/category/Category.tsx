  ...
  return (
    <div className="w-screen min-h-[750px] py-32 md:py-12 bg-gradient-to-r from-[#b7eafd] to-[#c2d4fc]">
      <div className="container px-4 md:px-0 mx-auto">
        <div className="text-black pt-10 w-full md:w-2/3">
          <h1 className="text-center px-4 md:px-6 leading-8 md:leading-10 md:text-start text-sm md:text-lg">
        ...
        <div className="bg-[#ffffff99] md:py-14 md:px-10 drop-shadow-2xl border-2 border-white backdrop-blur-3xl rounded-3xl mt-10 flex flex-wrap  flex-row md:flex-col">
          
          <div className="grid grid-cols-1 md:grid-cols-3 grid-rows-1 gap-4 text-black">
            <div className="flex flex-col items-center justify-center md:items-start space-y-4 p-4">
              ...
              <p className="text-center text-base md:text-start">
            ...
            <div className="flex flex-col items-center justify-center md:items-start space-y-4 p-4">
              ...
              <p className="text-center text-base md:text-start">
                شما می توانید با استفاده از سامانه صبابار، تمامی بارنامه های خود
                را مشاهده نمایید.
              </p>
            </div>
