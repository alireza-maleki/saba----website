  ...
  return (
    ...
    <div className="w-screen min-h-[600px] px-4 py-16 bg-gradient-to-r from-[#b7eafd] to-[#c2d4fc]">
        <div className="mx-auto container md:px-4 w-full md:w-2/3 text-center md:text-start text-black py-12">
            ...
            <h1 className="text-lg px-6 md:px-0">شبکه عظیم صبا کارت که تلفیقی از شبکه نظام بانکی و حمل و نقل کشوری می باشد. در سراسر ایران عزیزمان فعال است.</h1>
      ...
      {/* flex flex-col md:flex-row items-center justify-around md:space-x-12 text-black py-8 */}
        {/* <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-1 gap-8 py-4">
          <div className="flex flex-col space-y-4 p-4 text-center">
            <span className="font-bold text-4xl md:text-6xl text-[#263d5a]">
              {
          ...
          <div className="flex flex-col space-y-4 p-4 text-center">
            <span className="font-bold text-4xl md:text-6xl text-[#263d5a]">
            {
                counterOn && <CountUp start={0} end={93} duration={2} delay={0} />
              }
            </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-1 gap-8 py-4">
          <div className="flex flex-col space-y-4 p-4 text-center">
            <span className="font-bold text-4xl md:text-5xl text-[#263d5a]">
              {
                counterOn && <CountUp start={0} end={21095} duration={2} delay={0} />
              }
            </span>
            <p className="text-xl text-[#263d5a]">صبا کارت ها</p>
          </div>
          ...
          <div className="flex flex-col space-y-4 p-4 text-center">
            <span className="font-bold text-4xl md:text-5xl text-[#263d5a]">
              {
                counterOn && <CountUp start={0} end={31} duration={2} delay={0} />
              }
            </span>
          ...
          <div className="flex flex-col space-y-4 p-4 text-center">
            <span className="font-bold text-4xl md:text-5xl text-[#263d5a]">
              {
                counterOn && <CountUp start={0} end={19789} duration={2} delay={0} />
              }
            </span>
            <p className="text-xl text-[#263d5a]">رانندگان فعال</p>
          </div>
